...
print("Comparaison des pertes")
print(net.res_trafo.p_hv_mw[4])
print(net.res_trafo.q_hv_mvar[4])
print(net.res_trafo.pl_mw[4])
print(net.res_trafo.ql_mvar[4])
print(net.res_trafo.loading_percent[4])
