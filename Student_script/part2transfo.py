...
pp.create_transformer_from_parameters(net, hv_bus=N7, lv_bus=N105, sn_mva=550.0, name='N7N105', shift_degree=-10.0, vn_hv_kv=380.0, vn_lv_kv=150.0, vkr_percent=0.26, vk_percent=22.621494203522456, pfe_kw=0, i0_percent=0.0, tap_min=-20, tap_max=20, tap_step_percent=1, tap_pos=-4,tap_neutral=0, tap_side="hv", in_service=True,max_loading_percent = load_max)
...
print("Load utilization relative to rated power = {:.3f} [%]".format(net.res_trafo.loading_percent[4]))
...
print("-------------------------------------------------------")
print("Q2.2")
print("Transformation ratio :")
print("vn_hv_kv = {:.3f} kV".format(net.trafo.vn_hv_kv[2]))
print("vn_lv_kv = {:.3f} kV".format(net.trafo.vn_lv_kv[2]))
print("vn_kv on the high voltage side = {:.3f} kV".format(net.bus.vn_kv[N7]))
print("vn_kv on the low voltage side = {:.3f} kV".format(net.bus.vn_kv[N105]))
print("tap_pos  = {:.3f}".format(net.trafo.tap_pos[2]))

print(net.res_trafo.p_hv_mw[2])
print(net.res_trafo.q_hv_mvar[2])
print(net.res_trafo.pl_mw[2])
print(net.res_trafo.ql_mvar[2])
#print(net.res_trafo.loading_percent[2])
...
print("-------------------------------------------------------")
print("Q2.3")
print("Transformer phase shift angle  = {:.3f} degrees".format(net.trafo.shift_degree[2]))
...
print("Q2.4")
print("Transformation ratio :")
print("vn_hv_kv = {:.3f} kV".format(net.trafo.vn_hv_kv[0]))
print("vn_lv_kv = {:.3f} kV".format(net.trafo.vn_lv_kv[0]))
